...
I have visited research institutions abroad at [United Kingdom](#ZSL), [Sweden](#SLU) and [Italy](#UniTo). I have been also affiliated in two research institutions in Spain. In total, I have co-authored manuscripts with **114 researchers** from **18 countries**.
...
## **University of Sassari** (UNISS) {#UNISS}

<div class="col-sm-6" style="text-align: justify;">
I visited UNISS in 2025 for 1 month under the supervision of [Prof Apollonio](https://www.veterinaria.uniss.it/en/node/2266) and [Dr Scandura](https://veterinaria.uniss.it/it/node/2274). I got funding for this stay in the competitive call funded by the “University of Oviedo - Banco Santander - (4,000€)”. The stay focused on developing new tools for estimating wolf population density on a large scale. To do this, we analysed data from wolves tagged with GPS collars and worked with simulations. We hope to publish the results of this work in 2026. The stay also served to work on new advances at the [European Observatory of Wildlife](https://wildlifeobservatory.org/). 

</div>
<div class="col-sm-6">
![](images/FotoMarcoMassimo.jpg){width=350px}
</div>
